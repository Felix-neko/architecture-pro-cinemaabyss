...
- `NEW_MOVIE_SERVICE_PERCENT` - Процент трафика (0-100), направляемого на новый сервис фильмов. Используется для плавного перехода с моносервиса на микросервисы. 
...
docker run -p 8000:8000 \
  ...
  -e NEW_MOVIE_SERVICE_PERCENT=50 \
  proxy-service
```